...
public class Controller
{
    ...
    static DropButton[] dropButtonList = new DropButton[1];
    ...
    static void logic() {
        ...
        TextMethodPair[] drop1 = {new TextMethodPair("Button 1", ButtonMethods.Method.Blank), new TextMethodPair("Button 2", ButtonMethods.Method.Blank), new TextMethodPair("Button 3", ButtonMethods.Method.Blank), new TextMethodPair("Button 4", ButtonMethods.Method.Blank), new TextMethodPair("Button 5", ButtonMethods.Method.Blank), new TextMethodPair("Button 6", ButtonMethods.Method.Blank), new TextMethodPair("Button 7", ButtonMethods.Method.Blank), new TextMethodPair("Button 8", ButtonMethods.Method.Blank), new TextMethodPair("Button 9", ButtonMethods.Method.Blank), new TextMethodPair("Button 10", ButtonMethods.Method.Blank), new TextMethodPair("Button 11", ButtonMethods.Method.Blank), new TextMethodPair("Button 12", ButtonMethods.Method.Blank)};
        dropButtonList[0] = new DropButton(150, 70, 700, 600, drop1);
